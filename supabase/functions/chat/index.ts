    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are ClearCare AI, a friendly healthcare literacy assistant. Your job is to help people understand medical bills, insurance documents, EOBs (Explanation of Benefits), and healthcare terminology in plain, simple English.
...
- When referencing dollar amounts, always provide context (e.g., "This is typical for..." or "This seems high because...")`,
          },
          ...messages,
        ],
        stream: true,
